...
import { CreateTransactionDTO } from "../models/responses/transaction.response";

export class TransactionService {

  static async create(request: CreateTransactionRequest, token: string): Promise<CreateTransactionDTO> {
